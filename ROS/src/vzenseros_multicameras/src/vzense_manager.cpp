...
VzenseManager::VzenseManager(const string &ip, const string &camera_name) :
...
GET:
    ...
    VzDeviceInfo* pPsDeviceInfoList = new VzDeviceInfo[device_count];
    status =  VZ_GetDeviceInfoList(device_count,pPsDeviceInfoList);

    VzDeviceInfo* pPsDeviceInfo = nullptr;
